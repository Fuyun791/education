...
public class WebLogAspect {
     ...
     */
    private static ExecutorService executor = new ThreadPoolExecutor(5,12,2000L, TimeUnit.MILLISECONDS,
            new ArrayBlockingQueue<Runnable>(100),new ThreadFactoryBuilder().setNameFormat("ed-pool-%d").build(),
