...
public class CourseNameController {
  ...
  public RespBody findCourseName(CourseName courseName,
    ...
    List<CourseName> courseNameList = courseNameService
        .findCourseName(courseName, pageStart, pageSize);
  ...
  public RespBody findCourseNameList(CourseName courseName,
      ...
      @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize) {
    List<CourseName> courseNameList = courseNameService
        .findCourseInfoList(courseName, teacherNumber, pageStart, pageSize);
