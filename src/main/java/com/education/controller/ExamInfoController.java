...
public class ExamInfoController {
  ...
  public RespBody findExamInfoList(ExamInfo examInfo,
      @RequestParam(value = "pageStart", defaultValue = "1") Integer pageStart,
      @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize) {
    List<ExamInfo> examInfoList = examInfoService
        .findExamSubjectPlanList(examInfo, pageStart, pageSize);
    PageInfo<ExamInfo> pageInfo = new PageInfo<>(examInfoList);
    return RespBody.ok(pageInfo);
  }
  ...
  public RespBody findExamClassRoomPlanList(ClassRoomInfo classRoomInfo,
      @RequestParam(value = "pageStart", defaultValue = "1") Integer pageStart,
      @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize) {
    List<ClassRoomInfo> examInfoList = examInfoService
        .findExamClassRoomPlanList(classRoomInfo, pageStart, pageSize);
  ...
  public RespBody findExamTeacherPlanList(TeacherInfo teacherInfo,
      @RequestParam(value = "pageStart", defaultValue = "1") Integer pageStart,
      @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize) {
    List<TeacherInfo> examInfoList = examInfoService
        .findExamTeacherPlanList(teacherInfo, pageStart, pageSize);
  ...
  public RespBody findExamStudentPlanList(StudentInfo studentInfo,
      @RequestParam(value = "pageStart", defaultValue = "1") Integer pageStart,
      @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize) {
    List<StudentInfo> studentInfoList = examInfoService
        .findExamStudentPlanList(studentInfo, pageStart, pageSize);
