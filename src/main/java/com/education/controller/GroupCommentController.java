...
public class GroupCommentController {
    ...
    public RespBody findGroupComment(GroupComment groupComment,
        ...
        List<GroupComment> groupCommentList = groupCommentService.findGroupComment(groupComment, pageStart, pageSize);
    ...
    public RespBody insertGroupComment(@RequestParam("topicId") int topicId,
        ...
        int result = groupCommentService.insertGroupComment(topicId,studentNum,commentContent,dataCreate,dataModified);
        if (result == 1) {
            return RespBody.ok();
        }
        return RespBody.error();
