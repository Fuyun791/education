...
public class StuGroupRelationController {
    ...
    public RespBody findStuGroupRelation(StuGroupRelation stuGourpRelation,
        ...
        List<StuGroupRelation> stuGourpRelationList = stuGourpRelationService.findStuGroupRelation(stuGourpRelation, pageStart, pageSize);
    ...
    public RespBody deleteMyGroup(@RequestParam("studentNum")int studentNum,
        ...
        int result = stuGourpRelationService.insertMyGroup(studentNum,groupId,joinTime,dataCreate,dataModified);
        if (result == 1) {
            return RespBody.ok();
        }
        return RespBody.error();
