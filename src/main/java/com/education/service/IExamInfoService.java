...
public interface IExamInfoService extends IService<ExamInfo> {
  ...
  //教室考试安排列表
  List<ClassRoomInfo> findExamClassRoomPlanList(ClassRoomInfo classRoomInfo, Integer pageStart,
      Integer pageSize);

  //教师监考安排列表
  List<TeacherInfo> findExamTeacherPlanList(TeacherInfo teacherInfo, Integer pageStart,
      Integer pageSize);

  //学生考试安排列表
  List<StudentInfo> findExamStudentPlanList(StudentInfo studentInfo, Integer pageStart,
      Integer pageSize);
}
