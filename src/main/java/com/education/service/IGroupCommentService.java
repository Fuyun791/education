...
public interface IGroupCommentService extends IService<GroupComment> {
     ...
     * @return
     */
    List<GroupComment> findGroupComment(GroupComment groupComment, Integer pageStart, Integer pageSize);
    ...
    //插入一条评论
    int insertGroupComment (int topicId,int studentNum,String commentContent,String dataModified,String dataCreate);
