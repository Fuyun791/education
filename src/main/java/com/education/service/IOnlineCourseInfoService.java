...
public interface IOnlineCourseInfoService extends IService<OnlineCourseInfo> {
   ...
   * @return
   */
  List<OnlineCourseInfo> findOnlineCourseInfo(OnlineCourseInfo onlineCourseInfo, Integer pageStart,
      Integer pageSize);
   ...
   * @return
   */
  List<OnlineCourseInfo> findOnlineCourseList(Integer teacherId, Boolean isShare, Long collegeId,
      Integer checkedStatus, Boolean checkedResult, Integer pageStart, Integer pageSize);
