...
public interface IOnlineCourseStarService extends IService<OnlineCourseStar> {
   ...
   * @return
   */
  List<OnlineCourseStar> findOnlineCourseStar(OnlineCourseStar onlineCourseStar, Integer pageStart,
      Integer pageSize);
   ...
   * @return
   */
  int insertOnlineCourseStar(OnlineCourseStar onlineCourseStar, Long discussParent,
