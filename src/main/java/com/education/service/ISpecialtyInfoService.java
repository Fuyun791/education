...
public interface ISpecialtyInfoService extends IService<SpecialtyInfo> {
     ...
     * @return
     */
    List<SpecialtyInfo> findSpecialtyInfo(SpecialtyInfo specialtyInfo, Integer pageStart, Integer pageSize);
     ...
     * @return
     */
    List<SpecialtyInfo> findSpecialtyInfoList(SpecialtyInfo specialtyInfo, Integer collegeId, Integer pageStart, Integer pageSize);
