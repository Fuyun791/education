...
public interface IStuGroupRelationService extends IService<StuGroupRelation> {
     ...
     * @return
     */
    List<StuGroupRelation> findStuGroupRelation(StuGroupRelation stuGourpRelation, Integer pageStart, Integer pageSize);
    ...
    //关注一个小组
    int insertMyGroup(int studentNum,int groupId,String joinTime,String dataCreate,String dataModified);
