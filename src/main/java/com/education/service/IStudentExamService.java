...
public interface IStudentExamService extends IService<StudentExam> {
  ...
  //学生考试分数列表
  List<StudentInfo> findStudentExamResultList(StudentInfo studentInfo, Integer pageStart,
      Integer pageSize);

  //学生考试分数列表(包括学分)
  List<StudentInfo> findStudentExamResultList2(StudentInfo studentInfo, Integer pageStart,
      Integer pageSize);
