 ...
 */
@Service
public class AdminInfoServiceImpl extends ServiceImpl<AdminInfoMapper, AdminInfo> implements
    IAdminInfoService, UserDetailsService {
  ...
  public AdminInfo findAdminAndPopedomInfoById(Long adminId) {
    ...
    if (redisService.getByKey(str) == null) {
      adminInfo = adminInfoMapper
          .selectOne(new QueryWrapper<AdminInfo>().eq("admin_number", adminId));
  ...
  public UserDetails loadUserByUsername(String adminId) throws UsernameNotFoundException {
    AdminInfo adminInfo = adminInfoMapper
        .selectOne(new QueryWrapper<AdminInfo>().eq("admin_number", adminId));
    if (adminInfo != null) {
