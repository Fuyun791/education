 ...
 */
@Service
public class ClassInfoServiceImpl extends ServiceImpl<MyClassInfoMapper, ClassInfo> implements
    IClassInfoService {
  ...
  @Override
  public List<ClassInfo> findClassInfoList(ClassInfo classInfo, Integer collegeId,
