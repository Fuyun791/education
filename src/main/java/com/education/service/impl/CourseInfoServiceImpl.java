 ...
 */
@Service
public class CourseInfoServiceImpl extends ServiceImpl<CourseInfoMapper, CourseInfo> implements
    ICourseInfoService {
  ...
  @Override
  public List<CourseInfo> findCourseInfo(CourseInfo courseInfo, Integer pageStart,
      Integer pageSize) {
    //这里根据具体的条件进行扩充
  ...
  @Override
  public JSONObject findCourseInfoList(Integer teacherNumber, String teacherName,
      String courseName) {
    TeacherInfo teacherInfo = courseInfoMapper
        .findAllCourseInfoList(teacherNumber, teacherName, courseName);
  ...
  @Override
  public JSONObject findStudentCourseList(Integer studentNum, String studentName,
      String courseName) {
    StudentInfo studentInfo = courseInfoMapper
        .findStudentCourseList(studentName, studentNum, courseName);
    String[][] strings = new String[7][12];
    if (studentInfo == null) {
      return null;
    }
