 ...
 */
@Service
public class CourseTimeInfoServiceImpl extends
    ServiceImpl<CourseTimeInfoMapper, CourseTimeInfo> implements ICourseTimeInfoService {

  @Autowired
  private CourseTimeInfoMapper courseTimeInfoMapper;

  @Override
  public List<CourseTimeInfo> findCourseTimeInfo(CourseTimeInfo courseTimeInfo, Integer pageStart,
      Integer pageSize) {
    //这里根据具体的条件进行扩充
