 ...
 */
@Service
public class ExamInfoServiceImpl extends ServiceImpl<ExamInfoMapper, ExamInfo> implements
    IExamInfoService {
  ...
  //各科目考试安排
  @Override
  public List<ExamInfo> findExamSubjectPlanList(ExamInfo examInfo, Integer pageStart,
      Integer pageSize) {
    PageHelper.startPage(pageStart, pageSize);
  ...
  //教室考试安排列表
  @Override
  public List<ClassRoomInfo> findExamClassRoomPlanList(ClassRoomInfo classRoomInfo,
  ...
  //教师监考安排列表
  @Override
  public List<TeacherInfo> findExamTeacherPlanList(TeacherInfo teacherInfo, Integer pageStart,
      Integer pageSize) {
    PageHelper.startPage(pageStart, pageSize);
  ...
  //学生考试安排列表
  @Override
  public List<StudentInfo> findExamStudentPlanList(StudentInfo studentInfo, Integer pageStart,
      Integer pageSize) {
    PageHelper.startPage(pageStart, pageSize);
