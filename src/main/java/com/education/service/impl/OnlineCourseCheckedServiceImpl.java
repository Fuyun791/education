 ...
 */
@Service
public class OnlineCourseCheckedServiceImpl extends
    ServiceImpl<OnlineCourseCheckedMapper, OnlineCourseChecked> implements
    IOnlineCourseCheckedService {

  @Autowired
  private OnlineCourseCheckedMapper onlineCourseCheckedMapper;

  @Override
  public List<OnlineCourseChecked> findOnlineCourseChecked(OnlineCourseChecked onlineCourseChecked,
