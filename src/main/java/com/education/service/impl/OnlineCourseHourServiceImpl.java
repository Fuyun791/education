 ...
 */
@Service
public class OnlineCourseHourServiceImpl extends ServiceImpl<OnlineCourseHourMapper, OnlineCourseHour> implements IOnlineCourseHourService {

    @Autowired
    private OnlineCourseHourMapper onlineCourseHourMapper;

    @Override
    public List<OnlineCourseHour> findOnlineCourseHour(OnlineCourseHour onlineCourseHour, Integer pageStart, Integer pageSize) {
        //这里根据具体的条件进行扩充
