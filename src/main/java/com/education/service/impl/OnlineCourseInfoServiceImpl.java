 ...
 */
@Service
public class OnlineCourseInfoServiceImpl extends
    ServiceImpl<OnlineCourseInfoMapper, OnlineCourseInfo> implements IOnlineCourseInfoService {
  ...
  @Autowired
  public OnlineCourseInfoServiceImpl(OnlineCourseInfoMapper onlineCourseInfoMapper,
      OnlineCourseCheckedMapper onlineCourseCheckedMapper) {
    this.onlineCourseInfoMapper = onlineCourseInfoMapper;
    this.onlineCourseCheckedMapper = onlineCourseCheckedMapper;
  }

  @Override
  public List<OnlineCourseInfo> findOnlineCourseInfo(OnlineCourseInfo onlineCourseInfo,
  ...
  @Override
  public List<OnlineCourseInfo> findOnlineCourseList(Integer teacherId, Boolean isShare,
      Long collegeId, Integer checkedStatus, Boolean checkedResult, Integer pageStart,
      Integer pageSize) {
    PageHelper.startPage(pageStart, pageSize);
    return onlineCourseInfoMapper
