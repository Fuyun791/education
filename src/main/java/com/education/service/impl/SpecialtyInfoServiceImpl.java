 ...
 */
@Service
public class SpecialtyInfoServiceImpl extends
    ServiceImpl<SpecialtyInfoMapper, SpecialtyInfo> implements ISpecialtyInfoService {

  @Autowired
  private SpecialtyInfoMapper specialtyInfoMapper;

  @Override
  public List<SpecialtyInfo> findSpecialtyInfo(SpecialtyInfo specialtyInfo, Integer pageStart,
      Integer pageSize) {
    //这里根据具体的条件进行扩充
  ...
  @Override
  public List<SpecialtyInfo> findSpecialtyInfoList(SpecialtyInfo specialtyInfo, Integer collegeId,
