 ...
 */
@Service
public class StuGroupRelationServiceImpl extends ServiceImpl<StuGroupRelationMapper, StuGroupRelation> implements IStuGroupRelationService {

    @Autowired
    private StuGroupRelationMapper stuGourpRelationMapper;

    @Override
    public List<StuGroupRelation> findStuGroupRelation(StuGroupRelation stuGourpRelation, Integer pageStart, Integer pageSize) {
        //这里根据具体的条件进行扩充
    ...
    //关注一个小组
    @Override
    public int insertMyGroup(int studentNum,int groupId,String joinTime,String dataCreate,String dataModified){
        return stuGourpRelationMapper.insertMyGroup(studentNum,groupId,joinTime,dataCreate,dataModified);
    }
