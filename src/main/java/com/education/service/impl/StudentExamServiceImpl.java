...
public class StudentExamServiceImpl extends ServiceImpl<StudentExamMapper, StudentExam> implements IStudentExamService {
    ...
    @Override
    public List<StudentExam> findStudentExam(StudentExam studentExam, Integer pageStart, Integer pageSize) {
        //这里根据具体的条件进行扩充
    ...
    //学生考试分数列表
    @Override
    public List<StudentInfo> findStudentExamResultList(StudentInfo studentInfo, Integer pageStart, Integer pageSize){
        PageHelper.startPage(pageStart,pageSize);
    ...
    //学生考试分数列表(包括学分)
    @Override
    public List<StudentInfo> findStudentExamResultList2(StudentInfo studentInfo, Integer pageStart, Integer pageSize){
        PageHelper.startPage(pageStart,pageSize);
