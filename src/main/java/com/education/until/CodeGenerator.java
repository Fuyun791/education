...
public class CodeGenerator {
  ...
  public static void main(String[] args) {
    ...
    dsc.setUrl(
        "jdbc:mysql://localhost:3306/education?serverTimezone=GMT%2B8&characterEncoding=UTF-8");
    ...
    pc.setModuleName(scanner("请输入模块名(如education)"));
    pc.setParent("com");
    ...
    //选择是否有父类实体，公共父类strategy.setSuperControllerClass("你自己的父类控制器,没有就不用设置!")
