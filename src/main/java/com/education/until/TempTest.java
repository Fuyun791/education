...
public class TempTest {
  ...
  private static final Set<Long> ONLINE_COURSE_DISCUSS_SET = new HashSet<Long>(
  ...
  public static int isExist(OnlineCourseDiscuss onlineCourseDiscuss) {
    ...
    if (onlineCourseDiscuss.getDiscussToPerson() != null && !ONLINE_DISCUSS_PERSON
        .containsKey(onlineCourseDiscuss.getDiscussToPerson())) {
      result = 0;
    }
    return result;
  }
